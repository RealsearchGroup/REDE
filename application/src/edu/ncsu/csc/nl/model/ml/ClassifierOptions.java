...
public class ClassifierOptions {
	...
	private SecurityObjective _primaryAnnotation;
	...
	public ClassifierOptions(ClassificationAttribute primaryClassification, SecurityObjective primaryAnnotation, int foldType, WordType wordType, int numberOfFolds, boolean showRandomResults,
			                 String[] stopWords, boolean useTDFIDF) {
		_primaryClassification = primaryClassification;
		_primaryAnnotation = primaryAnnotation;
		_foldType = foldType;
		_wordType = wordType;
	...
	public SecurityObjective getPrimaryAnnotation() { return _primaryAnnotation; }
