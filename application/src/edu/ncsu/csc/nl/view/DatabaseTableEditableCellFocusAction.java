...
public class DatabaseTableEditableCellFocusAction extends WrappedAction implements ActionListener
{
	 ...
	 */
	public DatabaseTableEditableCellFocusAction(JTable table, KeyStroke keyStroke)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ( (originalColumn +1) == table.getModel().getColumnCount() ) {
			...
			GCController.getTheGCController().markCurrentSentenceAsDatabaseComplete();
			ActionEvent ae = new ActionEvent(table, 1, GCConstants.ACTION_DOCUMENT_GOTO_NEXT_DATABASE);
