...
public class ClassificationResult {
	...
	public ArrayList<SecurityObjectiveAnnotation> annotations = new ArrayList<SecurityObjectiveAnnotation>();
	...
	public boolean hasSecurityObjective(SecurityObjective so) {
		for (SecurityObjectiveAnnotation soa: annotations) {
			if (soa.getSecurityObjective() == so) { return true; }
		}
		return false;
	}
}
