...
public class ExpirementOptions {
	...
	private SecurityObjective _primarySecurityObjective;
	...
	public ExpirementOptions(SecurityObjective primaryObjective, int foldType, int k, int numberOfFolds, double threshold, boolean showRandomResults,
            SentenceDistance sentenceDistance, String[] stopWords) {
		_primarySecurityObjective = primaryObjective;
		_foldType = foldType;
		_k = k;
		_numberOfFolds = numberOfFolds;
		_threshold = threshold;
	...
	public SecurityObjective getPrimarySecurityObjective()    { return _primarySecurityObjective; }
